...
seedSize = [0.25,0.20,0.175,0.125,0.10]
for element in elemType:
	for sizes in seedSize:
		...
		s.rectangle(point1=(0.0, 0.0), point2=(12.0, 2.0))
		...
		p.DatumPlaneByPrincipalPlane(principalPlane=XZPLANE, offset=1.0)
		p = mdb.models['Model-1'].parts['beam']
		d1 = p.datums
		...
		side1Edges1 = s1.findAt(((1.0, 2.0, 0.0), ), ((6.0, 2.0, 0.0), ))
		...
		verts1 = v1.findAt(((4.0, 0.0, 0.0), ))
		region = a.Set(vertices=verts1, name='Set-3')
		mdb.models['Model-1'].PinnedBC(name='BC-3', createStepName='Step-1', 
			region=region, localCsys=None)
		...
		a = mdb.models['Model-1'].rootAssembly
		v1 = a.instances['beam-1'].vertices
		verts1 = v1.findAt(((12.0, 1.0, 0.0), ))
		a.Set(vertices=verts1, name='TIPNODE')	

		# Mesh Parts - added commentable opptions for the triangle nodes
		print 'Meshing Part'

		p = mdb.models['Model-1'].parts['beam']
		p.seedPart(size=sizes, deviationFactor=0.1, minSizeFactor=0.1)
		f = p.faces
		pickedRegions = f.findAt(((9.333333, 0.666667, 0.0), ), ((2.666667, 0.666667, 
			0.0), ), ((1.333333, 1.333333, 0.0), ), ((6.666667, 1.333333, 0.0), ))
	...
	#	elemType1 = mesh.ElemType(elemCode=element, elemLibrary=STANDARD,
		...
		p = mdb.models['Model-1'].parts['beam']
		f = p.faces
		faces = f.findAt(((9.333333, 0.666667, 0.0), ), ((2.666667, 0.666667, 0.0), ), 
			((1.333333, 1.333333, 0.0), ), ((6.666667, 1.333333, 0.0), ))
		pickedRegions =(faces, )
		...
		faces1 = f1.findAt(((9.333333, 0.666667, 0.0), ), ((2.666667, 0.666667, 0.0), 
			), ((1.333333, 1.333333, 0.0), ), ((6.666667, 1.333333, 0.0), ))
		...
		mdb.models['Model-1'].optimizationTasks['Task-1'].SingleTermDesignResponse(
			name='STRAIN', region=MODEL, identifier='STRAIN_ENERGY', 
		...
		mdb.models['Model-1'].optimizationTasks['Task-1'].ObjectiveFunction(
			name='MINIMIZE', objectives=((OFF, 'STRAIN', 1.0, 0.0, ''), ))
		...
		mdb.models['Model-1'].optimizationTasks['Task-1'].OptimizationConstraint(
			name='VolFRAC', designResponse='VOLUME', 
		...
		mdb.models['Model-1'].optimizationTasks['Task-1'].TopologyDemoldControl(
			name='Restrict-1', region=MODEL, collisionCheckRegion=DEMOLD_REGION, 
		pointRegion=None, csys=None, pullDirection=vector1, draftAngle=0.0, 
			technique=AUTO)
		...
		#	description='', prototypeJob='Opt-Process-1-Job', maxDesignCycle=25, 
		#	odbMergeFrequency=2, dataSaveFrequency=OPT_DATASAVE_SPECIFY_CYCLE, 
		#	saveInitial=False)
		#mdb.optimizationProcesses['Opt-Process-1'].Job(name='Opt-Process-1-Job', 
		#	model='Model-1', atTime=None, waitMinutes=0, waitHours=0, queue=None, 
		...
		mdb.CombineOptResults(
			optResultLocation='C:\\Users\\fox5500\\Documents\\Opt-Process-1', 
